...
function ZD_Controller(ip, log) {
    this.ip = ip;
    this.log = log;
    log.info('Assigning ZD Controller to IP %s', this.ip);
}

ZD_Controller.prototype.IlluminateAll = function() {
    // Turn on all lights
    var self = this;
...
ZD_Controller.prototype.ExtinguishAll = function() {
    // Turn off all lights
    var self = this;
...
ZD_Controller.prototype.GroupListGet = function() {
...
ZD_Controller.prototype.IlluminateGroup = function(groupNumber, desiredIntensity) {
    var self = this;
...
ZD_Controller.prototype.ThemeListGet = function() {
    // Get the list of light groups from the controller
    var self = this;
...
ZD_Controller.prototype.IlluminateTheme = function(themeIndex, onOff) {
    var self = this;
    var requestData = JSON.stringify({
