...
var Theme = function(accessory, log, Homebridge, Controller) {
...
Theme.prototype.getPower = function(callback) {
    var self = this;
...
Theme.prototype.setPower = function(powerOn, callback) {
    var self = this;
...
Theme.prototype.pollingBrightness = function() {
    var self = this;
...
Theme.prototype.illuminateTheme = function(callback, onOff) {
    var self = this;
...
Theme.prototype.returnTheme = function(info) {
    var self = this;
    return Promise.resolve()
        .then(function() {
...
Theme.prototype.getCurrentState = function(callback) {
    var self = this;
