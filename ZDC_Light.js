...
var ZDC_Light = function(accessory, log, Homebridge, Controller) {
...
ZDC_Light.prototype.getPower = function(callback) {
    var self = this;
    //self.log.debug("Getting power state for: ", self.accessory.displayName);
    self.getCurrentState(callback, "power");
};

ZDC_Light.prototype.setPower = function(powerOn, callback) {
    var self = this;
...
ZDC_Light.prototype.getBrightness = function(callback) {
    var self = this;
    return Promise.resolve()
        .then(function() {
...
ZDC_Light.prototype.setBrightness = function(brightness, callback) {
    var self = this;
...
ZDC_Light.prototype.pollingStatus = function() {
    var self = this;
...
ZDC_Light.prototype.setHue = function(value, callback) {
    var self = this;
...
ZDC_Light.prototype.getHueSaturation = function(callback) {
    var self = this;
    return controller.ColorListGet(self.accessory.context.color)
        .then(function(colors) {
...
ZDC_Light.prototype.setSaturation = function(value, callback) {
    var self = this;
...
ZDC_Light.prototype.colorListSet = function(whichcall, callback) {
    var self = this;
    if (whichcall === 'hue') {
        callback_h = callback;
...
ZDC_Light.prototype.groupListEdit = function() {
    var self = this;
...
ZDC_Light.prototype.illuminateGroup = function(callback, desiredIntensity, whichcall) {
    var self = this;
    callback();
...
ZDC_Light.prototype.getCurrentState = function(callback, whichcall) {
    var self = this;
